                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-1">
                              <StatusIcon className={`w-3 h-3 ${statusColors[leave.status].text}`} />
                              <span className={`font-medium truncate ${statusColors[leave.status].text}`}>
                    ...
                    <tr key={leave.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className={`flex items-center gap-2 px-3 py-1 rounded-full ${statusColors[leave.status].bg} ${statusColors[leave.status].border} border w-fit`}>
                          <StatusIcon className={`w-4 h-4 ${statusColors[leave.status].text}`} />
                          <span className={`text-sm font-medium ${statusColors[leave.status].text}`}>
                            {leave.status}
                          </span>
                        </div>
                      </td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1">従業員</label>
                <p className="text-gray-900 font-medium">{getEmployeeName(selectedLeave.employee_id)}</p>
              </div>

              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1">希望日</label>
              ...
              <div>
                ...
                <div className={`flex items-center gap-2 px-3 py-1 rounded-full ${statusColors[selectedLeave.status].bg} ${statusColors[selectedLeave.status].border} border w-fit`}>
